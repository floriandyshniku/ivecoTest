    ...
    <section className="vehicles-container">
      <div className="vehicles-wrapper">
        <div className="tab-items">
           <button onClick={() => setActive("firstCard")}>Tutti i veicoli</button>
           <button onClick={() => setActive("secondCard")}>Tutti i veicoli</button>
           <button onClick={() => setActive("thirdCard")}>Tutti i veicoli</button>
           <button onClick={() => setActive("fourthCard")}>Tutti i veicoli</button>
           <button onClick={() => setActive("fifthCard")}>Tutti i veicoli</button>
           <button onClick={() => setActive("sixthCard")}>Tutti i veicoli</button>
           <button onClick={() => setActive("seventhCard")}>Tutti i veicoli</button>
        </div>
        {active === "firstCard" &&   <div className="container">
